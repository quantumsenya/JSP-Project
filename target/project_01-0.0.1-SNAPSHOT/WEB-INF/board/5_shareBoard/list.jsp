...
<script src="${contextPath}/resources/js/board/list/shareboardlist.js"></script>
...
<div class="container">
	...
	<thead class="thead-dark">
		...
		<c:choose>
			<c:when test="${empty list}">
				<tr>
					<td colspan="8" class="text-center"><b>작성된 게시물이 없습니다.</b></td>
				</tr>
			</c:when>
			<c:otherwise>
	...
	<div class="float-right">
		<a href="${contextPath}/board/shareboard/writeForm" class="btn btn-primary">글쓰기</a>
	</div>
	</form>
</div>
<div class="container">
