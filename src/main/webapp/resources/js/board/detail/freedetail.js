...
$(function(){
	...
	$('.toList').on('click',function(){
		viewForm.attr({
			"action":`${contextPath}/board/freeboard`,
			"method":"get"
		}).empty() // 파라미터 정보 삭제
		.submit();
	});
	...
	$('.modify').on('click',function(){
		viewForm.attr({
			"action":`${contextPath}/board/freeboard/modFreeBoard`,
			"method":"post"
		}).submit();
	});
	...
	$('.remove').on('click',function(){
		viewForm.attr({
			"action":`${contextPath}/board/freeboard/removeFreeBoard`,
			"method":"post"
		}).submit();
	});
...
$(function(){
	...
	$('.reply_write').on('click', function(){
		...
		let writernick = $('.reply_writernick').val()
