...
<script src="${contextPath}/resources/js/reply/newsreply.js"></script>
<script src="${contextPath}/resources/js/board/detail/newsroomdetail.js"></script>
		...
		<tr>
			...
			<td>
				<c:if test="${not empty auth and auth.id!=board.writer}">
					<a type="button" class="btn btn-warning suggest" href="${contextPath}/board/newsroom/suggest?bno=${board.bno}">
			...
			<td colspan="3">
				...
				<div class="my-3">
					<c:if test="${not empty board.imageFile}">
						...
						<div class="preview">
							<img class="origImg" src="${contextPath}/fileDownload?no=${board.bno}&imageFileName=${board.imageFile}&path=board/newsroom">
						</div>
					</c:if>
